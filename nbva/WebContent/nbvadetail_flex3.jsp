...
/*************************************************************************************************************************************************************/
public void  buildCellsTotals( JspWriter out, ContractData contract, String formUrl  ) throws IOException {
	String cells = "";
	String xDataItem = null;
	String color1 = "plum";
	String style1 = "font-family: sans-serif; color: white;";
	...
	<div class="flex-container">
	  ...
	  <div>Contract Totals 
	   <%
		...
		out.println("<tbody id=\"report\">");
		  buildCellsTotals(out, contractData, formUrl); // build data cells from file
		//out.println(cells);
		out.println("</tbody></table><BR>"); // Close Table
