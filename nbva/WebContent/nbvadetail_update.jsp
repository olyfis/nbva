...
public void  buildCellsTotals( JspWriter out, ContractData contract, String formUrl, double sumTotal  ) throws IOException {
	...
	out.println( "<td class=\"a\">" + sumTotal + "</td></tr>");
	out.println("<tr>"); 
	...
	if (listArrSZ > 0) {	
		for (int i = 0; i < listArrSZ; i++ ) {
			...
			for (int j = 0; j < rtnArrSZ; j++ ) {
				...
				cells +="<TD>" + asset.getTermDate() + "</td></tr> ";
		...
		cells +="<TR><TD COLSPAN=\"16\" align=\"center\">  <input type=\"Submit\" name=\" dispCode\"   value=\" Update\"   >      </td></tr> </form>";
